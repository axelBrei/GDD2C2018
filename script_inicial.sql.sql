...
ALTER TABLE [TheBigBangQuery].[Espectaculo] 
    ADD CONSTRAINT [FK_RUBR] FOREIGN KEY ([espe_rubro]) REFERENCES [TheBigBangQuery].[Rubro](rub_id);

ALTER TABLE [TheBigBangQuery].[Espectaculo]
    ADD CONSTRAINT [FK_EMPR] FOREIGN KEY ([espe_empresa]) REFERENCES [TheBigBangQuery].[Empresa](empr_id);
